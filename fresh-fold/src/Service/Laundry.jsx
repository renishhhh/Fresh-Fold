...
const MensWearDropdown = ({ addToBag }) => {
    ...
    return (
        <div className="dropdown w-full">
            <h2
                ...
                className="text-xl font-semibold cursor-pointer bg-indigo-300 p-3 rounded-md"
            >
                Men's Wear <i className="ml-72 text-xl fa-solid fa-circle-chevron-down"></i>
            </h2>
            <ul
        ...
        <div className="bag-section bg-indigo-100 p-4 rounded-md w-full">
            ...
            <div className="mt-2 text-lg">
                {bagItems.map((item, index) => (
                    <>
                        <p className="text-gray-500 text-center text-base mb-1">Men's Wear</p>
    ...
    return (
        <>
            ...
            <div className="flex justify-center gap-5 p-6 w-full">
                {/* Spacing on the left side (20%) */}
                <div className="w-1/5"></div>

                {/* Men's Wear Dropdown (40%) */}
                <div className="w-2/5">
                    <MensWearDropdown addToBag={addToBag} />
                </div>
