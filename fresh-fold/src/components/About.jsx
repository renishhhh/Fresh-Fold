...
const About = () => {
    return (
        <>
            <div className="relative">
                <img src="./public/about.jpg" alt="" className="w-full h-96 object-cover" />
            ...
            <div className=" flex justify-around mt-16">
                <img src="./public/about2.jpg" alt="" className="w-[40%] h-96 object-cover ml-20 rounded-md" />
    ...
    <div className="flex flex-row justify-evenly items-center space-x-8 space-y-6">
        <div className="con-1 text-center flex flex-col items-center">
            <img className="w-24 h-24 mb-4 rounded-full" src="./public/commit.gif" alt="Swift Service" />
        ...
        <div className="con-1 text-center flex flex-col items-center">
            <img className="w-24 h-24 mb-4 rounded-full" src="./public/commit.gif" alt="Exceptional Care" />
        ...
        <div className="con-1 text-center flex flex-col items-center">
            <img className="w-24 h-24 mb-4 rounded-full" src="./public/commit.gif" alt="Transparency" />
...
<img className="w-24 h-24 mb-4 rounded-full" src="./public/vision.gif" alt="Swift Service" />
