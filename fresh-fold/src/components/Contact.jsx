      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            <img className='w-[80%] h-auto ml-8' src="./public/Contact2.png" alt="Contact" />
          </div>
          <div className="lg:w-2/6 md:w-1/2 bg-cyan-200 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 mr-7">
